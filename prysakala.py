...
mydb = mysql.connector.connect(
    ...
    database = "darba_vakances"
)
mycursor = mydb.cursor()

sql = "INSERT INTO vakances (uzņēmums, profesija, novads, alga, darba_laiks, izglītība, klātiene_neklātiene) VALUES (%s, %s, %s, %s, %s, %s, %s)"
val = [
  ("Digitālās Inovācijas SIA, Datu analītiķis, 28 500 EUR gadā, Rīga, ")
  ()
]
